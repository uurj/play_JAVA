...
public class ObjectClassTest {
	...
	// 회원의 아이디가 같으면 같은 객체
	// 같은객체여부를 비교할때는 반드시 equals() 메서드로 비교해야함 ****짱중요
	public static void main(String[] args) {
		...
		System.out.println(dto1.hashCode());	// 참조값a
		System.out.println(dto2.hashCode());	// 참조값a
		System.out.println(dto3.hashCode());	// 참조값x
