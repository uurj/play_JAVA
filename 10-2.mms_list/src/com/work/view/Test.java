...
public class Test {
	...
	public static void main(String[] args) {
		...
		service.addMember("test01", "pass2", "이재머", "010-1000-2000", "ds@work.com");
		...
		System.out.println("아이디회원정보가 존재 ㄴ");
		...
		print("user01");
		dto = service.removeMember("user01");
		if (dto != null) {
			System.out.println("[탈퇴성공]" + dto.getName() + "님 그동안 안녕");
		} else {
